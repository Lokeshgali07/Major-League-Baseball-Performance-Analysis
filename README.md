...
This project analyzes historical Major League Baseball (MLB) data using SQL for data exploration and Power BI for interactive visualization. The objective is to uncover insights into player careers, school contributions, salary trends, and player characteristics using relational data.<br><br>
[Project Documentation](SQL_Query_documentation/Document1.pdf)
---
...
Contact: `lokeshgali07@gmail.com` <br>
LinkedIn : `linkedin.com/in/lokeshgali`
